...
There are several main components to sharing the bee occurrences records associated with the USFWS GLRI project on the Global Biodiversity Information Facility platform.
...
Currently, this table is not part of the SQL Server database and the table needs to be exported to a location that can be accessed by the people involved in publishiing to Darwin Core.
